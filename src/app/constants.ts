export class UrlConstants {
  ...
  public static createEvent: string = 'create-event';
  public static editEvent: string = 'edit-event';
  public static createActivty: string = 'create-activity';
...
export class GeneralConstants {
  public static ApiDateTime: string = 'YYYY-MM-DDTHH:mm:ss';
}
